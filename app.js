...
app.get('/allcontacts', function (req, res) {
    ...
    let contactsFilter = contacts.filter(contact => contact && contact.name.indexOf(req.query.name) > -1);
...
app.post('/deletecontact', formParser, function (req, res) {
    let idContact = contacts.findIndex(contact => contact && contact.id == req.body.id);
